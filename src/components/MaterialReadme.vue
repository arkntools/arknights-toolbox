<template>
  <ul class="mdui-typo mdui-m-y-0" style="font-size:14px">
    <template v-if="$root.localeCN">
      ...
      <li><span v-theme-class="['mdui-text-color-pink-accent', 'mdui-text-color-pink-a100']">粉色字材料</span>代表该材料存在原始需求，而不仅仅是上位材料所需的合成材料</li>
    ...
    <template v-else>
      ...
      <li><span v-theme-class="['mdui-text-color-pink-accent', 'mdui-text-color-pink-a100']">Material name with a pink color</span> means it has original demand, but not only be used to synthesize.</li>
