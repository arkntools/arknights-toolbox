<template>
  <ul class="mdui-typo mdui-m-y-0" style="font-size:14px">
    <template v-if="$root.localeCN">
      ...
      <li>点击一次材料名字旁边的<b>合成</b>按钮可模拟全部合成（扣除原材料，增加产物）</li>
      ...
      <li><b>我该刷什么图</b>可以计算最优的刷图路线，仅供参考，掉落概率数据来自<a href="https://penguin-stats.io/" target="_blank">企鹅物流数据统计</a></li>
    </template>
    <template v-else>
      ...
      <li><b>"What Missions Should I Operate Repeatedly"</b> is a function to calculate the optimal missions by linear programming. All probability data are from <a href="https://penguin-stats.io/" target="_blank">penguin stats</a>.</li>
    </template>
  </ul>
</template>
