<template>
    <div class="mdui-row mdui-typo mdui-center" style="max-width: 1012px;">
        <div class="mdui-col-xs-12">
            ...
            <h2>更新日志</h2>
            <p>干员数据最后更新日期：<code>2019-09-06</code></p>
            <h4>2019-09-06</h4>
            <p>【精英材料计算】计算素材获取最优策略可选择是否包含活动图（这次的无限池也算“活动图”）</p>
            <h4>2019-08-24</h4>
            <p>【精英材料计算】中素材合成所需在移动设备上将直接显示</p>
            <h4>2019-08-10</h4>
            <p>增加“记住最后一次打开的页面”选项（方便移动设备使用 PWA 应用）<br />优化移动设备在【精英材料计算】中合成材料的工具提示</p>
            <h4>2019-07-14</h4>
            <p>【精英材料计算】增加关卡性价比计算</p>
            <h4>2019-07-13</h4>
            <p>【精英材料计算】点击掉落信息可显示相关关卡的掉落详情</p>
            <h4>2019-07-11</h4>
            <p>【公开招募计算】增加“显示非公开招募干员”选项（方便直接筛选干员跳转 WIKI）<br />【精英材料计算】增加模拟合成功能</p>
            <h4>2019-07-08</h4>
